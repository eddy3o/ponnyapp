...
const PhoneCompanyCard = ({ companySearch, onSelect }) => {
    ...
    const filteredCompanies = phoneCompanies.filter(
        (company) => company.name.toLowerCase().includes(companySearch.toLowerCase())
    );
